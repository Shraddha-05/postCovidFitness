...
public class MainIntroActivity extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(new SimpleSlide.Builder()
            .title("Hello My Name is Shraddha")
            .description("Welcome to our Post Covid Fitness app , this app wil help you to determine whether you are healthy or else you are suffering from covid or any other disease")
